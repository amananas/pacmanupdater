...
MODULE_NAME=pacmanupdater
CONFIG_DIR=~/.pacmanupdater
CONFIG_FILE_DEFAULTS=pacmanupdater.conf.json
CONFIG_FILE_NAME=pacmanupdater.conf.json
EXEC_FILE_LOCATION=/usr/bin
EXEC_FILE_NAME=pacmanupdater
...
case $1 in
    "install")
        ...
        sudo -E cp pacmanupdater.py $EXEC_FILE_LOCATION/$EXEC_FILE_NAME
